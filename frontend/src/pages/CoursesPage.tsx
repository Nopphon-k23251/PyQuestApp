              ...
              >
                <div>
                  ...
                  <div className="flex flex-wrap gap-1.5 mb-6">
                    {["พื้นฐาน", "เงื่อนไข", "ลูป", "สตริง", "ลิสต์", "ดิกชันนารี", "ฟังก์ชัน", "โจทย์ประยุกต์"].map((topicName) => (
                      <span
                        key={topicName}
                        className="px-2 py-0.5 text-[11px] font-medium rounded-md bg-white/5 text-slate-300 border border-white/5"
                      >
                        {topicName}
                      </span>
                    ))}
